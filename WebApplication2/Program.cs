...
builder.Services.AddDbContext<LibraryIdentityContext>(options =>
       ...
       options.UseSqlServer(builder.Configuration.GetConnectionString("WebAppli" +
       "cation2Context") ?? throw new InvalidOperationException("Connection" +
       "string 'WebApplication2' not found.")));
